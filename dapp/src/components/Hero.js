...
function Hero() {
  ...
  useEffect(() => {
    async function getRecentlyMintedNFTs() {
        ...
        for (let i = totalSupply - 1; i >= Math.max(totalSupply - numberOfNFTsToFetch, 0); i--) {
      ...
      <div className="">
        ...
        <div className="container justify-items-center">
          <div className="caption">
            <h5 className="text-center">Total staked nfts at vault : {totalStakedNft} NFTs</h5>
            <p className="text-center subpixel-antialiased" style={{ color: "#fff" }}>
